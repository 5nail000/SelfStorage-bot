...
def callback_query(call):
    ...
    if call.data == "order_diag1_no":
        ...
        markup = InlineKeyboardMarkup()
        markup.row_width = 6
        button01 = InlineKeyboardButton('1', callback_data='order_months#01')
        button02 = InlineKeyboardButton('2', callback_data='order_months#02')
        button03 = InlineKeyboardButton('3', callback_data='order_months#03')
        button04 = InlineKeyboardButton('4', callback_data='order_months#04')
        button05 = InlineKeyboardButton('5', callback_data='order_months#05')
        button06 = InlineKeyboardButton('6', callback_data='order_months#06')
        button07 = InlineKeyboardButton('7', callback_data='order_months#07')
        button08 = InlineKeyboardButton('8', callback_data='order_months#08')
        button09 = InlineKeyboardButton('9', callback_data='order_months#09')
        button10 = InlineKeyboardButton('10', callback_data='order_months#10')
        button11 = InlineKeyboardButton('11', callback_data='order_months#11')
        button12 = InlineKeyboardButton('12', callback_data='order_months#12')
        button_pre = InlineKeyboardButton('<<-- Назад', callback_data="do_order")
